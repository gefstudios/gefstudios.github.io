...
export function HomeView(): string {
  const gameCards = games.map((game) => GameCard(game)).join('');

  return `
    ${Header()}

    <section class="relative min-h-screen flex flex-col justify-center items-center px-4 pt-20 pb-10">
      <div class="z-10 max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-12 md:gap-6">
        ...
        <div class="w-full md:w-1/2 space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
          <p class="font-gaming text-[#00f3ff] text-base md:text-lg tracking-widest uppercase animate-pulse">
            Bem-vindo ao Próximo Nível
          </p>
          <h1 class="font-gaming text-4xl md:text-7xl font-black tracking-tighter text-white uppercase leading-none">
            NÓS FORJAMOS <br>
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#00f3ff] to-[#9d4edd] neon-text">
              REALIDADES
            </span>
          </h1>
          <p class="text-gray-400 text-base md:text-xl max-w-xl font-light">
    ...
    <section id="games" class="py-32 px-6 max-w-7xl mx-auto relative">
      <div class="text-center mb-16 reveal">
        <h2 class="font-gaming text-4xl md:text-6xl font-bold text-white uppercase">
          Nossas <span class="text-[#9d4edd]">Criações</span>
        </h2>
        <div class="w-24 h-1 bg-[#9d4edd] mx-auto mt-4"></div>
        <p class="text-gray-500 text-sm font-gaming uppercase mt-4 tracking-widest animate-pulse md:hidden">
    ...
    <section id="about" class="py-32 bg-[#0d0d11] border-y border-gray-900 px-6">
      <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div class="w-full md:w-1/2 space-y-6 reveal">
        ...
        <div class="w-full md:w-1/2 grid grid-cols-2 gap-4 reveal">
          <div class="p-6 bg-[#121214] border border-gray-800 text-center">
    ...
    <section id="contact" class="py-32 px-6 max-w-4xl mx-auto text-center reveal">
      <h2 class="font-gaming text-4xl md:text-6xl font-bold text-white uppercase mb-6">
